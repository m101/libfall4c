...
/*! @brief                          Fonction d'allocation de liste doublement chainee
*   @param    double_linked_list    Liste doublement chainee pour lequel allouer un nouveau noeud
*/
t_double_linked_list *double_linked_list_append_new_node (t_double_linked_list *double_linked_list_previousNode)
{
    ...
    // On alloue le noeud
    double_linked_list_previousNode = malloc(sizeof(t_double_linked_list));
    // Initialisation de la liste nouvellement allouée
    double_linked_list_zero(double_linked_list_previousNode);
    double_linked_list_previousNode->prev = temp;
    // On ferme la liste
    double_linked_list_previousNode->next = NULL;
